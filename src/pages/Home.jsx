  ...
  return (
    <div ref={rootRef}>
      <SEO
        ...
        description="Frontend Developer building fast React web apps and WordPress websites for businesses that are tired of looking like everyone else. Clean code, real performance, no jargon."
      />
